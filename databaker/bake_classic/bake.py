...
import databaker.bake_classic.overrides as overrides       # warning: changes xypath and messytables

from databaker.bake_classic.utils import showtime, TechnicalCSV
import databaker.bake_classic.utils
...
def main():
    Opt = Options()
    databaker.bake_classic.utils.showtime_enabled = Opt.timing
    databaker.bake_classic.constants.constant_params = Opt.params
